    ...
    public Vector2 PlayerNodeValue()
    {
        ...
        foreach (Node n in grid)
        {
            if (playerNode == n)
            {
                ...
                return new Vector2((Mathf.Abs(worldBottomLeft.x - Mathf.RoundToInt(player.transform.position.x / nodeDiameter))), Mathf.Abs(worldBottomLeft.z - Mathf.RoundToInt(player.transform.position.z / nodeDiameter)));
